...
*Tags: [v2026.1] (data models), 
       [v1.4.0][TR-369-v1.4.0] (USP specification didn't change), 
       [v1.17.0][TR-106-v1.17.0] (TR-106), 
       [v2.21.0][TR-181-v2.21.0] (TR-181)*
...
*Tags: [v1.4.0] (data models), 
       [v1.4.0][TR-369-v1.4.0] (USP specification), 
...
*Tags: [v1.3.1] (data models), 
       [v1.3.0][TR-369-v1.3.0] (USP specification didn't change), 
...
[TR-106-v1.17.0]: https://github.com/BroadbandForum/data-model-template/releases/tag/v1.17.0
...
[TR-181-v2.21.0]: https://github.com/BroadbandForum/device-data-model/releases/tag/v2.21.0
...
[TR-369-v1.4.0]: https://github.com/BroadbandForum/usp/releases/tag/v1.4.0
